---
title: "Inference Project4: Simulation Exercise and ToothGrowth Data Analysis"
author: "Shuai Wang"
...
plot(hist(simulated),xlab="Value",ylab="Frequency",col="blue",main="Histogram Plot of 40 Exponential Distribution Simulation Runs")
```
...
Here I load the ToothGrowth data with basic exploratory data analyses using ggplot2().
```{r}
library(datasets)
data(ToothGrowth)
library(ggplot2)
